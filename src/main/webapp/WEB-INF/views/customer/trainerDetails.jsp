      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                <div class="six-months">
               	<h4> <strong>Schedule:</strong> ${ts.days}</h4><br>
       	 	<h5> <strong>Timing:</strong>From ${requestScope.startTime} to ${requestScope.endTime}</h5> <br>
            <h4> <strong>Price:</strong> ${s.priceForSixMonth} INR (inclusive of taxes) </h4> <br>
